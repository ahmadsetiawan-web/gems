...
export type TugasPengembalianOrganik = {
  id: string;
...
export default function PemeriksaanPengembalianOrganikList({
  data,
}: {
  data: TugasPengembalianOrganik[];
}) {
        ...
        >
          ...
          <div className="mt-3">
            ...
            <p className="mb-1 text-xs text-slate-400">
              Catat kalau ada kerusakan atau jumlah yang tidak sesuai — ini
              jadi catatan penting untuk kantor.
            </p>
            <textarea
